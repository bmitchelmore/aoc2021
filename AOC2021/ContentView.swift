...
enum Puzzles: String, CaseIterable {
    ...
    func puzzle(input: String) throws -> Puzzle {
        ...
        case .Day19Puzzle1:
            return try AOC2021.Day19Puzzle1(contents: input)
        case .Day19Puzzle2:
            return try AOC2021.Day19Puzzle2(contents: input)
        case .Day20Puzzle1:
            return try AOC2021.Day20Puzzle1(contents: input)
        case .Day20Puzzle2:
            return try AOC2021.Day20Puzzle2(contents: input)
        case .Day21Puzzle1:
            return try AOC2021.Day21Puzzle1(contents: input)
        case .Day21Puzzle2:
            return try AOC2021.Day21Puzzle2(contents: input)
        }
    }
